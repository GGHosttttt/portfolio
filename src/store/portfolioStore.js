...
import minio from "@/assets/images/projects/minio.png";
import sms from "@/assets/images/projects/sms.jpg";
import webserver from "@/assets/images/projects/webserver.jpg";
    ...
    skills: [
      {
        ...
        description:
          "Focus on solving real-world problems through clean and efficient code. Apply best practices such as modular design, maintainable architecture, debugging, and performance optimization to deliver reliable software solutions.",
      ...
      },
      {
        ...
        description:
          "Build responsive and interactive user interfaces using Next.js and Vue.js. Create reusable components, manage application state, handle client-side routing, and integrate REST APIs to deliver smooth and user-friendly experiences.",
      ...
      },
      {
        ...
        description:
          "Designed and developed microservices using FastAPI and Docker, implementing internal service-to-service communication, API integration, and scalable architecture patterns.",
      ...
      },
      {
        ...
        description:
          "Experience with MinIO object storage and migrating bucket data to AWS S3, integrating secure cloud storage into Dockerized microservices.",
        icon: "fa-light fa-database",
      },
    ],
    ...
    projects: [
      {
        ...
        images: [webserver],
        description:
          "Deployed and managed projects on a VPS using Docker and Nginx, secured servers with firewall rules, Fail2Ban, and SSH tunnels, and set up domain registration with DNS management via Cloudflare.",
        icon: "fa-light fa-server",
      },
      {
        id: 4,
        demo: false,
        detail: false,
        title: "Storage Bucket with MinIO",
        category: "Cloud",
        images: [minio],
        description:
          "MinIO file storage solution with integrated monitoring via Prometheus and Grafana dashboards.",
      },
      {
        id: 1,
        demo: false,
      ...
      },
      {
        ...
        images: [lbk1, lbk2, lbk3, lbk4],
        description:
          "Loukbontor is an e-commerce website that specalize on selling second-hand product. Varies of products are still good in use, so why not sell to LoukBontor! This plateform is also the market places for user who have too much unuse product, last but not least user can donate with us too. This project developed in our Javascript Subject in Laravel Web Development Course.",
        tools: [
          {
            name: "User interface",
          ...
          {
            name: "Integration",
            technology: "Javascript fetch APIs",
      ...
      },
      {
        ...
        images: [sos1, sos2, sos3, sos4],
        description:
          "A website provide all network service including internet, security, set up applicaton smart home and camera. That not all, selling all those network tools are our feature too, user can access network-related resources such as article and ",
        tools: [
          {
            name: "User interface",
            technology: "HTML, CSS + Bootstrap",
      ...
      },
      {
        ...
        demo: false,
        detail: false,
        title: "School Managment System (Short Course School)",
        category: "Management",
        images: [sms],
        description:
          "Developed a backend-focused school management system with OAuth2 authentication, role-based access control, QR-based student attendance, device tracking, and notifications. While the frontend is minimal, the backend is robust and fully functional.",
      },
    ],
    project: null,
